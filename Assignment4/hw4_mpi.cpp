...
void HeatSimulationMPI(int argc, char **argv)
{
    ...
    for (i = 0; i < X_RESN; i++)
    {
        int cur = i * X_RESN;
        tempmap[cur] = 20.0f;
        tempmap[cur+X_RESN-1] = 20.0f;
        tempmap[i] = 20.f;
        tempmap[(X_RESN-1)*Y_RESN+i] = 20.0f;
    }
